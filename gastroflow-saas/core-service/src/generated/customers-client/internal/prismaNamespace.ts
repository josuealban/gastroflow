...
> = {
  ...
  meta: {
    modelProps:
      'customer' | 'reservation' | 'customerNote' | 'customerPreference';
    ...
    CustomerNote: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.CustomerNoteCountAggregateOutputType>
            | number;
        };
      };
    };
    CustomerPreference: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.CustomerPreferenceCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type CustomerPreferenceScalarFieldEnum =
  (typeof CustomerPreferenceScalarFieldEnum)[keyof typeof CustomerPreferenceScalarFieldEnum];
